...
public class AeronClusterConstants {
  ...
  public static final int SNAPSHOT_CHANNEL_STREAM_ID_OFFSET = 120;
  public static final int ORDER_EVENTS_CHANNEL_STREAM_ID_OFFSET = 130;

  private AeronClusterConstants() {
    // no-op
  }
}
